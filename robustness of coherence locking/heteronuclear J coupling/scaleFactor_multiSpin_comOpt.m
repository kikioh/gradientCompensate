...
data = load('SL-sin-SmAndLzSm-1ms-H30kHz-C20kHz-05G.mat');
...
% sweep chemical shift
numBW = 10;
omegaH = linspace(-para.spin.BWH/2,para.spin.BWH/2,numBW);
omegaC = linspace(-para.spin.BWC/2,para.spin.BWC/2,numBW);
